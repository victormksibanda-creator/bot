...
from ._ldap_sasl_base import BaseMySQLLdapSaslPasswordAuthPlugin

AUTHENTICATION_PLUGIN_CLASS = "MySQLLdapSaslPasswordAuthPlugin"


# pylint: disable=c-extension-no-member,no-member
class MySQLLdapSaslPasswordAuthPlugin(BaseMySQLLdapSaslPasswordAuthPlugin):
    ...
    async def auth_switch_response(
        ...
        if len(packet) >= 6 and packet[5:7] == b"r=":
